...
This will register your view components with Laravel.  In the case of `Alert::class`, it can be referenced in views as `<x-enigma-alert />`, where `enigma` is the prefix you provided during registration.
